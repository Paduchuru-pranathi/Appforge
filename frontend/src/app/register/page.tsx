...
export default function RegisterPage() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      toast.success('Account created! Welcome to AppForge 🎉');
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-900 to-indigo-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-primary-300 mt-2">Create your free account</p>
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input {...register('password')} type="password" placeholder="Min 6 characters" className="input pl-10" />
              </div>
